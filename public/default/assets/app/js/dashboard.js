...
var Dashboard = function() {
    ...
    var dailySales = function() {
    	...
    	$.ajax
    	({
    		url : base_url + "/request/dashboard/getdailysales",
    		data : params,
    		dataType : "Json",
    		type : "POST",
    			...
    			if(response.is_error == 0)
    			{
    				...
    				var chartData = {
    						...
    						datasets: [{
    							...
    							data: response.daily_orders_array
    						}, {
    							//label: 'Dataset 2',
    ...
    var getstockproducts = function() {
		...
		({
			...
			type : "POST",
			success : function(response){ 
				console.log(response.stock_products_array);
				var chart = AmCharts.makeChart("MStockChart", {
			        "type": "serial",
			        "theme": "light",
			        "dataProvider": JSON.parse(response.stock_products_array),
			        "valueAxes": [{
			            "gridColor": "#FFFFFF",
			            "gridAlpha": 0.2,
			            "dashLength": 0
    ...
    var OrderStockChart = function() {
		...
		$.ajax
		({
			url : base_url + "/request/dashboard/getoutboundorders",
			data : params,
			dataType : "json",
			type : "POST",
			success : function(response){ 
				$("#TOTAL_ORDER").html(response.total_order_amount);
		        ...
		        var config = {
		            ...
		            data: {
		                ...
		                datasets: [{
		                    ...
		                    //fill: 'start',
		                    data: JSON.parse(response.order_stock_amount)
		                }]
		            },
		            options: {
		                title: {
