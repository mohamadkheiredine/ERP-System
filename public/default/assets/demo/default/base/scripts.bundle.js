...
$(document).ready(function() {
    ...
    $('button[name=btn_save_fyear]').on('click',function(){
    	 var fisical_year = $("select[name=fisical_year]").val();
    	 var _token = $("input[name=_token]").val(); 
    	 
    	 // close old data and add a new records
    	  var base_url = $('#BASE_URL').val(); 
	        

	        var str_params = { fisical_year : fisical_year ,  _token : _token };
	         $.ajax
	        ({
	            url : base_url + "/request/accounting/generateyearconfiguration",
	            data : str_params,
	            method : 'post',
	            dataType : "json",
	            beforeSend : function(){
	            ...
	            success : function(response){
            		...
            		{
	            		 setCookie('fisical_year',fisical_year,3600);
	            		bootbox.confirm("You Need Tio reload Page to affect function", function(result){
