...
orders_module = {
    DisplayListOrders: function () {
        ...
        $.ajax({
            ...
            data: {
                _token: _token,
                so_order_warehouse: so_order_warehouse,
                so_order_customer: so_order_customer,
                so_vendor_id: so_vendor_id,
    ...
    DeleteOrderProduct: function () {
        var base_url = $("input[name=base_url]").val();
        var _token = $("input[name=_token]").val();
        let order_id = $("input[name=so_id]").val();
        var stock_id = $(this).data("stock_id");
        $.ajax({
            url: base_url + "/request/orders/deleteOrderProduct",
            data: { _token, order_id, stock_id },
            method: "post",
            dataType: "json",
            beforeSend: function () {},
            success: function (response) {
    ...
    OpenAddOrderProductsModal: function () {
        $("select[name=ii_warehouse_id]").select2("destroy").select2();
        $("select[name=bi_product]").select2("destroy").select2();
    ...
    getProductPrice: function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.is_error == 0) {
                    $("input[name=so_product_cost]").val(
