...
operations_module = {
		DisplayListOperations : function(){
		    ...
		    var params = { _token : _token , so_id : so_id};
		    $.ajax
                    ({
                        url : base_url + "/request/shipment/operations/displaylistorders",
                        data : params,
                        dataType : "json",
                        type : "POST",
                        success : function(response){
                ...
                AddOperationOrder : function(){
                    return operations_module.AddOperationOrderSubmitHandler();
                },
                AddOperationOrderSubmitHandler : function(){
                    	 var AddOrderForm = $('#FRM_ADD_ORDERS');
	         var error3 = $('.alert-danger', AddOrderForm);
	         var success3 = $('.alert-success', AddOrderForm);
	         ...
	         AddOrderForm.validate({
	             ...
	             submitHandler: function (form) {
	    	        ...
	    	        var str_params = $("#FRM_ADD_ORDERS").serialize();
	    	        
	    	         $.ajax
	    	        ({
	    	            url : base_url + "/request/shipment/operations/addorder",
	    	            data : str_params,
	    	            method : 'post',
	    	            dataType : "json",
	    	            beforeSend : function(){
