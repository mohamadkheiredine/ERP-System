...
projectroles_module = {
	DisplayListProjectRoles : function(){
	    ...
	    $.ajax
	    ({
	        url : base_url + "/request/projects/displayliststatuses",
	        data : { _token : _token },
            method : 'post',
            dataType : "json",
            beforeSend : function(){
	...
	SaveProjectStatusInfo : function(){
		return projectstatus_module.SaveProjectStatusSubmitHandler();
	},
	SaveProjectStatusSubmitHandler : function(){
             ...
             submitHandler: function (form) {
    	       ...
    	       // var _token = $('input[name=_token]').val();
    	        ...
    	        str_params = str_params;
    	         $.ajax
    	        ({
    	            url : base_url + "/request/projects/savestatusinfo",
    	            data : str_params,
    	            method : 'post',
    	            dataType : "json",
    	            success : function(response){
    	              ...
    	              {
    	                 window.location.href = base_url + "/projects/statuses";
    	              }
    	            }
    	        });
             }
	...
	DeleteProjectStatusData : function(){
			...
			if(result == true)
			{
			      ...
			      var _token = $('input[name=_token]').val();
			        var str_params ={ps_id : ps_id , _token : _token};
			         $.ajax
			        ({
			            url : base_url + "/request/projects/deletestatusinfo",
			            data : str_params,
			            dataType : "Json",
			            type : "POST",
			            success : function(response){
	...
	EditProjectStatusInfo : function(){
		var ps_id = $(this).data('ps_id');
	    var base_url = $("#BASE_URL").val();
