							...
							<div class="m-portlet__head">
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">Add New Category</h3>
									</div>
								</div>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="clearfix margin-top-10">
                                                        <div>
                                                            <span class="btn default btn-file" style="text-align: left;">
                                                                ...
                                                                <input type="file" name="sc_avatar_pic" id="CC_AVATAR_PIC" /> </span>
                                                        </div>
                                                        <br>
                                                ...
                                                <div class="col-md-4">
                                                     <div class="form-group">
                                                        ...
                                                        <input type="text" name="sc_category_name" id="SC_CATEGORY_NAME" class="form-control" required="required" maxlength="100"  value="" />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label> Category Parent</label>
                                                        <select class="bs-select form-control" name="fk_sc_id" id="FK_SC_ID" data-actions-box="true">
