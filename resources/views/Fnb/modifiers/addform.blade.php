...
<div class="card shadow-sm">
  <div class="card-header">
    <h3 class="card-title">Add New Modifier</h3>
  ...
  <div class="card-body">
    <form name="frm_save_modifiers" id="FORM_SAVE_MODIFIER" style="max-width: 100%; overflow-x: hidden;">
      <div class="form-body">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" name="m_modifier_name" id="M_MODIFIER_NAME" class="form-control" required maxlength="255" value="" />
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="form-select form-control" data-control="select2" id="M_ITEM_ID" name="m_item_id">
                ...
                <option value="{{ $item_info->p_id }}">{{ $item_info->p_product_name }}</option>
                @endforeach
              </select>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input type="text" name="m_quantity" id="M_QUANTITY" class="form-control" required placeholder="Enter Quantity" />
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input type="text" name="m_cost_modifier" id="M_COST_MODIFIER" class="form-control" required />
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input type="text" name="m_price_modifier" id="M_PRICE_MODIFIER" class="form-control" required />
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="form-group">
              ...
              <label class="form-check form-switch form-check-custom form-check-solid">
                <input class="form-check-input" type="checkbox" name="m_is_active" id="M_IS_ACTIVE" value="1" />
          ...
          <div class="col-md-3">
            <div class="form-group">
              <br />
              <label class="form-check form-switch form-check-custom form-check-solid">
                <input class="form-check-input" type="checkbox" name="m_is_required" id="M_IS_REQUIRED" value="1" />
                <span class="form-check-label fw-semibold text-muted">
                  Modifier Required?
                </span>
              </label>
          ...
          <div class="col-md-3">
            <div class="form-group">
              <br />
              <label class="form-check form-switch form-check-custom form-check-solid">
                <input class="form-check-input" type="checkbox" name="m_is_single" id="M_IS_SINGLE" value="1" />
                <span class="form-check-label fw-semibold text-muted">
                  Modifier Single
                </span>
              </label>
