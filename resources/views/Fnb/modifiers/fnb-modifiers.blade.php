@extends('layouts.layout',['page_title' => "Modifiers Management"])
...
<script type="text/javascript" src="{{ url('js/libraries/fnb/modifiers/modifiers.js') }}"></script>
@endsection

@section('content')
<div class="card shadow-sm">
  <div class="card-header">
    <h3 class="card-title">FNB Modifiers</h3>
    ...
    <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
      <div class="row align-items-center">
        ...
        <div class="col-xl-4 order-1 order-xl-2 text-end">
          <a href="{{ url('fnb/modifiers/addform') }}" class="btn btn-info">
            <i class="fas fa-user me-1"></i> New Modifier
          </a>
        </div>
      </div>
    </div>
      ...
      <table class="table table-bordered table-hover" width="100%">
        <thead>
          <tr>
            ...
            <th title="Modifier Label">Name</th>
        ...
        <tbody class="LstModifierssGrid" id="LstModifiersGrid">
        </tbody>
      </table>
    </div>
    <div class="row">
      <div class="col-md-10" align="left">
        <ul id="ModifiersPagination" class="pagination-sm"></ul>
      </div>
