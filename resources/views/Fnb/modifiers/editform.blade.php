          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="form-select form-control" data-control="select2" id="M_UNIT_ID" name="m_unit_id">
                ...
                <option value="{{ $unit_info->su_id }}" {{ $modifier->m_unit_id == $unit_info->su_id ? 'selected' : '' }}>{{ $unit_info->su_unit_code }}</option>
                @endforeach
              </select>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="form-select form-control" data-control="select2" id="M_CURRENCY_ID" name="m_currency_id">
                ...
                <option value="{{ $currency_info->cc_id }}" {{ $modifier->m_currency_id == $currency_info->cc_id ? 'selected' : '' }}>{{ $currency_info->cc_currency_code }}</option>
                @endforeach
              </select>
            </div>
          </div>
