@extends('layouts.layout',['page_title' => "Kitchen Management"])
...
<script type="text/javascript" src="{{ url('js/libraries/fnb/kitchen/kitchen.js') }}"></script>
@endsection

@section('content')
<div class="card shadow-sm">
  <div class="card-header">
    <h3 class="card-title">FNB Kitchen Stations</h3>
  ...
  <div class="card-body">
    ...
    <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
      <div class="row align-items-center">
        ...
        <div class="col-xl-4 order-1 order-xl-2 text-end">
          <a href="{{ url('fnb/kitchen/addform') }}" class="btn btn-info">
            <i class="fas fa-user me-1"></i> New Kitchen Station
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-12 table-responsive">
        <table class="table table-rounded table-striped border gy-7 gs-7">
            ...
            <th title="Kitchen Description">Description</th>
            <th style="width:4px;white-space: nowrap;" title="#">edit</th>
            <th style="width:4px;white-space: nowrap;" title="#">Delete</th>
          </tr>
        </thead>
        <tbody class="LstTablesGrid" id="LstKitchensGrid">
        </tbody>
      </table>
    </div>
    <div class="row">
      <div class="col-md-10" align="left">
        <ul id="KitchensPagination" class="pagination-sm"></ul>
      </div>
