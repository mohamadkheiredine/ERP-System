                    ...
                    <div class="row">
                    	...
                    	<div class="col-md-4">
                             <div class="form-group">
                                ...
                                <input type="text" name="ca_account_code" id="CA_ACCOUNT_CODE" class="form-control" required="required" maxlength="255"  value="{{ $client_code }}" />
                            </div>
                        </div>
                    	<div class="col-md-4">
                              <div class="form-group">
                    	...
                    	<div class="col-md-4">
                             <div class="form-group">
                                ...
                                <input type="text" required="required"  name="ca_account_email" id="CA_ACCOUNT_EMAIL" class="form-control"  maxlength="255"  value="" />
                            </div>
                        </div>
                    	<div class="col-md-4">
                             <div class="form-group">
                                <label class="control-label">Mobile <span class="required"> * </span></label>
                                <input type="text" required="required"  name="ca_account_mobile" id="CA_ACCOUNT_MOBILE" class="form-control"  maxlength="255"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                              <div class="form-group">
                         ...
                         <div class="col-md-4">
                          ...
                          <div class="col-md-4">
                             <div class="form-group">
                                ...
                                <input type="text" name="ca_billing_house" id="CA_BILLING_HOUSE" class="form-control" maxlength="255" value="" />
                            </div>
                        </div>
                          <div class="col-md-4">
                             <div class="form-group">
                                <label class="control-label">Full Address</label>
                                <textarea style="width:100%;height:250px;resize:none" name="ca_billing_address" id="CA_BILLING_ADDRESS" class="form-control"></textarea>
                            </div>
                        </div>
                     </div>
                     <div class="row" style="height:50px;"></div>
