<?php
/***********************************************************
viewpurchasequotation.blade.php
Product :
Version : 1.0
Release : 1
								...
								<div class="tab-pane" id="m_tab_products" role="tabpanel">
									 <table class="table m-table m-table--head-separator-primary">
										...
										<tbody id="ListProducts">
											@foeach($quotation_products as $index => $qp_info )
											<tr data-index="{{ $index }}" class="QuotationItems">
												<th>
												{{ $index }} 
												<input type="hidden" name="product_id[]" class="ProductId" value="{{ $qp_info->products->p_id }}" />
												<input type="hidden" name="currency_id[]" class="CurrencyId" value="{{ $qp_info->sp_product_description }}" />
											</th>
												...
												<td><input type="text" name="serial_numbers[]" class="form-control SerialNumbers" value="{{ $qp_info->sp_product_serial }}" /></td> 
												<td></td>
											</tr>
											@endforeach
										</tbody>
