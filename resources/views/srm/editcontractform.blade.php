                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                          	<div class="form-group">
                                ...
                                <input type="text" name="sc_contract_title" id="SC_CONTRACT_TITLE" class="form-control" required="required" maxlength="255"  value="{{ $contract_info->sc_contract_title }}" />
                            </div>
                        </div>
                        <div class="col-md-4">
                          	<div class="form-group">
                                <label class="control-label"> Contract Date <span class="required"> * </span></label>
                                <input type="text" name="sc_contract_date" id="SC_CONTRACT_DATE" class="form-control" readonly="readonly" required="required" maxlength="15"  value="{{ $contract_info->sc_contract_date }}" />
                            </div>
                        </div>
                        <div class="col-md-4">
                          	<div class="form-group">
                                <label class="control-label"> Delivery Date <span class="required"> * </span></label>
                                <input type="text" name="sc_contract_delivery_date" id="SC_CONTRACT_DELIVERY_DATE" class="form-control" readonly="readonly" required="required" maxlength="15"  value="{{ $contract_info->sc_contract_delivery_date }}" />
                            </div>
                        </div>
                        <div class="col-md-4">
                              <div class="form-group">
