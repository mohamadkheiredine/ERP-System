                                        ...
                                        <div class="form-body">
                                             <span id="hidden_fields">
                                              <div class="form-group">
                                                {!! csrf_field() !!}
                                                <input type="hidden" name="sc_id" id="SC_ID" value="{{ $category_info->sc_id }}" />
                                                 </div>
                                            </span>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                      <div class="form-group">
                                                            ...
                                                            <input type="text" name="sc_category_ref" id="SC_CATEGORY_REF" class="form-control" required="required" maxlength="15"  value="{{ $category_info->sc_category_ref }}" />
                                                        </div>
                                                </div>
                                                <div class="col-md-4">
                                                     <div class="form-group">
                                                        <label class="control-label">Category Name <span class="required"> * </span></label>
                                                        <input type="text" name="sc_category_title" id="SC_CATEGORY_Title" class="form-control" required="required" maxlength="255"  value="{{ $category_info->sc_category_title }}" />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="bs-select form-control" name="fk_category_id" id="FK_Category_ID" data-actions-box="true">
                                                                ...
                                                                @foreach ( $lst_supplier_categories as $key => $cc_info )
                                                                        <option {{ $category_info->fk_category_id == $cc_info->sc_id ? "selected" : ""  }} value="{{ $cc_info->sc_id }}" >{{ $cc_info->sc_category_title }}</option>
                                                                @endforeach
                                                        </select>
                                                    </div>
                                                </div>
