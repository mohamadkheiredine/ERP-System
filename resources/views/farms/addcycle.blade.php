...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">Add Farm Cycle</h3>
        ...
        <div class="card-body">
            <form  id="FORM_SAVE_CYCLES" name="form_save_cycles">
                @csrf
                <div class="row mb-12">
                    <div class="col-md-4">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 text-end">
                        ...
                        <button type="submit" class="btn btn-sm btn-secondary">Import Excel</button>
