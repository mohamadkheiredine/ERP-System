	...
	<div class="m-portlet__head">
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				<h3 class="m-portlet__head-text">Manage Job Information</h3>
			</div>
		</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                                ...
                                <input type="text" name="j_due_date" tabindex="2"  id="J_DUE_DATE" class="form-control" required="required" maxlength="10" readonly="readonly"  value="{{ $job_info->j_due_date }}" />
                            </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
