                    ...
                    <div class="row">
                        <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="text" name="pu_unit_label" id="PU_UNIT_LABEL" class="form-control" required="required" maxlength="255"  value="" />
                                </div>
                        </div>
                        <div class="col-md-4">
                              <div class="form-group">
                                    <label class="control-label"> Units <span class="required"> * </span></label>
                                    <input type="number"  min="0" max="20"  step="0.01" name="pu_units" id="PU_UNITS" class="form-control" required="required" maxlength="15"  value="" />
                                </div>
                        </div>
                        <div class="col-md-4">
                          	<div class="form-group">
                                <label class="control-label"> Units Ammount <span class="required"> * </span></label>
                                <input type="text" name="pu_unit_amount" id="PL_UNIT_AMOUNT" class="form-control" required="required" maxlength="15"  value="" />
                            </div>
                        </div> 
                         <div class="col-md-4">
                            <div class="form-group">
