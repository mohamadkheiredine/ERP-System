                    	...
                    	<div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="bs-select form-control" name="pl_phone_type" id="PL_PHONE_TYPE" data-actions-box="true">
                                        ...
                                        <option value="2"> Mtc touch </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="text" name="pl_line_title" id="PL_LINE_TITLE" class="form-control" required="required" maxlength="255"  value="" />
                                </div>
                        </div> 
                        <div class="col-md-4">
                              <div class="form-group">
                                    <label class="control-label"> Line Number <span class="required"> * </span></label>
                                    <input type="text" name="pl_line_number" id="PL_LINE_NUMBER" class="form-control" required="required" maxlength="15"  value="" />
                                </div>
                        </div> 
                        <div class="col-md-4">
                          	<div class="form-group">
                                <label class="control-label"> Total Units <span class="required"> * </span></label>
                                <input type="text" name="pl_total_units" id="PL_TOTAL_UNITS" class="form-control" required="required" maxlength="15"  value="" />
                            </div>
                        </div> 
                    </div>
