                    ...
                    <div class="row">
                        <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="text" name="ls_status_title" id="LS_STATUS_TITLE" class="form-control" required="required" maxlength="255"  value="" />
                                </div>
                        </div>
                        <div class="col-md-4">
                             <div class="form-group">
                                <label class="control-label">Status Color</label>
                                <input type="color" name="ls_status_color" id="LS_STATUS_COLOR" class="form-control" required="required" maxlength="8"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                             <div class="form-group">
                                <label class="control-label">Parent Status</label>
                                 <select class="bs-select form-control" name="ls_parent_status" id="LS_PARENT_STATUS" data-actions-box="true">
                                        ...
                                        @foreach ( $lst_lead_status as $key => $status_info )
                         ...
                         <div class="col-md-12">
                             <div class="form-group">
								...
								<textarea name="ls_status_description" id="LS_STATUS_DESCRIPTION" class="form-control" style="width:100%;height:250px;"></textarea>
                            </div>
                        </div>
                    </div>
