...
@extends('layouts.layout',['page_title' => "CRM Management"])
...
@section('plugins')
    ...
    <script type="text/javascript" src="{{ url('js/libraries/crm/appresults.js') }}"></script>
@endsection

@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">App Results Management</h3>
		...
		<span id="hidden_fields">
            ...
            <div class="form">
                <div class="row align-items-center">
                        ...
                        <div class="form-group m-form__group row align-items-center">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="ar_result_parent" id="AR_RESULT_PARENT"  class="form-control form-select" data-control="select2" data-placeholder="Select Parent Result">
                                    ...
                                    @foreach ( $lst_results_parents as $key => $parent_info )
                                        <option value="{{ $parent_info->ar_id }}">{{ $parent_info->ar_app_result }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 align-right">
                        <a href="{{ url('/leads/results/addform') }}"
            ...
            <div class="table-responsive">
                <table class="table table-striped gy-7 gs-7">
                    ...
                    <tbody class="LstAppResults" id="LstAppResults"></tbody>
                </table>
            </div>
            <div class="row">
                <div class="col-md-10" align="left">
                    <ul id="AppResultsPagination" class="pagination-sm"></ul>
                </div>
