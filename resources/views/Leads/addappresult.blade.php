...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">Add New App Result</h3>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="ar_result_parent" id="AR_RESULT_PARENT"   class="form-control form-select" data-control="select2" data-placeholder="Select Parent Result">
                                    ...
                                    @foreach($lst_results_parents as $key => $res_info)
                                        <option value="{{ $res_info->ar_id }}">{{ $res_info->ar_app_result }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="ar_app_result" id="AR_APP_RESULT" class="form-control" value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"> Result Color <span class="required"> * </span></label><br/>
                                <input type="color" name="ar_result_color" required="required" id="AR_RESULT_COLOR" class="form-control" value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <label class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" name="ar_app_show_apt" id="AR_APP_SHOW_APT"   value="1"  />
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea style="width:100%;height:250px;resize:none" id="AR_APP_DESCRIPTION"  class="form-control" name="ar_app_description"  cols=""></textarea>
                            </div>
                        </div>
                    </div>
