                    ...
                    <div class="row">
                        <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="text" name="ut_team" id="UT_TEAM" class="form-control" required="required" maxlength="255"  value="" />
                                </div>
                        </div>
                        <div class="col-md-4">
                             <div class="form-group">
                         ...
                         <div class="col-md-12">
                             <div class="form-group">
								...
								<textarea name="ut_description" id="UT_DESCRIPTION" class="form-control" style="width:100%;height:250px;"></textarea>
                            </div>
                        </div>
                    </div>
