...
@section('plugins')
    ...
    <script type="text/javascript" src="{{ url('js/libraries/expenses/categories.js') }}"></script>
@endsection
        ...
        <div class="card-body">
    	 <span id="hidden_fields">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <a href="{{ url('expenses/categories/addform') }}" class="btn btn-info">
							<span>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-row-dashed table-row-gray-300 gy-7">
                            ...
                            <tbody  class="LstExpCategoriesGrid"></tbody>
                        </table>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-10" align="left">
                    <ul id="ExpCategoriesPagination" class="pagination-sm"></ul>
                </div>
