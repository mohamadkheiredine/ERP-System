...
@foreach($lst_expenses as $index => $expense_info)
    <tr class="odd gradeX" data-ac_id="{{ $expense_info->ac_id }}">
        ...
        <td><a href="#" data-ac_id="{{ $expense_info->ac_id }}"  id="EDIT_EXPENSE_{{ $expense_info->ac_id }}" ><i class="fas fa-edit" height="16"></i></a></td>
        <td><a href="#"  data-ac_id="{{ $expense_info->ac_id }}" id="DELETE_EXPENSE_{{ $expense_info->ac_id }}" ><i class="fa fa-minus-circle" aria-hidden="true" height="16" ></i></a></td>
    </tr>
@endforeach
