...
@extends('layouts.layout',['page_title' => "Expenses Categories - Add New Category"])
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="ec_name" id="EC_NAME" class="form-control" required="required" maxlength="255" value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea style="width:100%;height:250px;" name="ec_description" id="EC_DESCRIPTION" class="form-control"></textarea>
                        </div>
                    </div>
