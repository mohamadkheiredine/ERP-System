                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="w_warehouse_city" id="W_WAREHOUSE_CITY" class="form-control" maxlength="45"  value="" />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label> Warehouse Street </label>
                                                        <input type="text" name="w_warehouse_street" id="W_WAREHOUSE_STREET" class="form-control" maxlength="255"  value="" />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label> Warehouse Location </label>
                                                        <textarea name="w_warehouse_location" id="W_WAREHOUSE_LOCATION" class="form-control" style="width:100%;height: 95px;resize:none"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" maxlength="10" name="w_opening_time" id="W_OPENING_TIME" class="form-control"   value="" />
                                                    </div>
                                                </div> 
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label> Closing Time </label>
                                                        <input type="text" maxlength="10" name="w_closing_time" id="W_CLOSING_TIME" class="form-control"   value="" />
                                                    </div>
                                                </div> 
                                                <div class="col-md-12">
                                                    <div class="form-group">
