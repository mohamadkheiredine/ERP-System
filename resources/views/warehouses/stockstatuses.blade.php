...
@section('plugins')
    ...
    <script type="text/javascript" src="{{ url('js/libraries/inventory/stockstatusreport.js') }}"></script>
@endsection

@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">Warehouse Stock Status Report</h3>
            ...
            <div class="table-responsive">
                <table class="table table-rounded table-striped border gy-7 gs-7" width="100%">
                    ...
                    <tr class="fw-semibold fs-6 text-gray-800 border-bottom border-gray-200">
                        ...
                        <th title="Quantity">Total Stock</th>
                        <th title="Quantity">Stock Status</th>
                    </tr>
                    </thead>
                    <tbody id="LstStockStatus">
