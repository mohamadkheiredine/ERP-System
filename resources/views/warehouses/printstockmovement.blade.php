...
<div class="page">
    ...
    <table aria-label="Stock Movement">
        <thead>
        <tr>
            <th class="col-name">Type</th>
            <th class="col-name">Description</th>
            <th class="col-name">Warehouse</th>
        ...
        <tbody>
        @foreach($lst_warehouse_movements as $index => $mov_info)
            <tr>
                <td class="col-name">{{ $mov_info->wm_action_type }}</td>
                <td class="col-name">{{ $mov_info->wm_action_description }}</td>
                <td class="col-name">{{ $mov_info->Warehouse->w_warehouse_name }}</td>
                <td class="col-name">{{ $mov_info->Product->p_barcode }} </td>
                <td class="col-name">{{ $mov_info->Product->p_product_name }}</td>
                <td class="col-name">{{ $mov_info->wm_quantity }}</td>
            </tr>
