...
<div class="page">
    ...
    <table aria-label="Stock Availability">
        <thead>
        <tr>
            <th class="col-name">Warehouse Name</th>
            <th class="col-name">Product Code</th>
            <th class="col-name">Product Name</th>
            <th class="col-name">Total Stock</th>
            <th class="col-name">Stock Status</th>
        </tr>
        </thead>
        <tbody>
        ...
        @foreach($lst_stock_status as $index => $status_info)
            <tr>
                <td class="col-name">{{ $status_info->warehouse_name }} </td>
                <td class="col-name">{{ $status_info->p_product_ref }}</td>
                <td class="col-name">{{ $status_info->p_product_name }}</td>
                <td class="col-name">{{ $status_info->total_stock }}</td>
                <td class="col-name">{{ $status_info->stock_status }}</td>
            </tr>
