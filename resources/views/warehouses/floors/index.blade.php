...
@extends('layouts.layout',['page_title' => "Warehouse Floors Management"])


@section('plugins')
    <script type="text/javascript" src="{{ url('js/modules/warehousefloors.module.js') }}"></script>
    <script type="text/javascript" src="{{ url('js/libraries/inventory/warehousefloors.js') }}"></script>
@endsection

@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">Warehouse Floors</h3>
            ...
            <div class="col-md-12">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 align-right">
                        <a href="{{ url('inventory/floors/addform') }}" class="btn btn-info">
												<span>
