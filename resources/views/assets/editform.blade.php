            ...
            <form name="frm_save_asset" id="FORM_SAVE_ASSET">
                <div class="form-body">
                    <span id="hidden_fields">
                        {!! csrf_field() !!}
                        <input type="hidden" name="aa_id" value="{{ $asset_info->aa_id }}" />
                    </span>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="aa_asset_name" id="AA_ASSET_NAME" class="form-control" required="required" maxlength="255" value="{{ $asset_info->aa_asset_name }}" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select  name="aa_category_id" id="AA_CATEGORY_ID" class="form-select" data-control="select2" data-placeholder="Select Category">
                                    ...
                                    @foreach ( $lst_categories as $key => $category_info )
                                        <option {{ $asset_info->aa_category_id == $category_info->ac_id ? "selected" : "" }} value="{{ $category_info->ac_id }}">{{ $category_info->ac_category_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="aa_purchase_date" id="AA_PURCHASE_DATE" class="form-control" required="required" maxlength="10" readonly value="{{ $asset_info->aa_purchase_date }}" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Purchase Price <span class="required"> * </span></label>
                                <input type="text" name="aa_purchase_price" id="AA_PURCHASE_PRICE" class="form-control" required="required" maxlength="10" value="{{ $asset_info->aa_purchase_price }}" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select  name="aa_currency_id" id="AA_CURRENCY_ID" class="form-select" data-control="select2" data-placeholder="Select Currency">
                                    ...
                                    @foreach ( $lst_currencies as $key => $currency_info )
                                        <option {{ $asset_info->aa_currency_id == $currency_info->cc_id ? "selected" : "" }} value="{{ $currency_info->cc_id }}">{{ $currency_info->cc_currency_name }}  ( {{ $currency_info->cc_currency_code }} )</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="aa_depreciation_rate" id="AA_DEPRECIATION_RATE" class="form-control" required="required" maxlength="10" value="{{ $asset_info->aa_depreciation_rate }}" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Current Value <span class="required"> * </span></label>
                                <input type="text" name="aa_current_value" id="AA_CURRENT_VALUE" class="form-control" required="required" maxlength="12" value="{{ $asset_info->aa_current_value }}" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select  name="aa_location" id="AA_LOCATION" class="form-select" data-control="select2" data-placeholder="Select Location">
                                    ...
                                    @foreach ( $lst_locations as $key => $location_info )
                                        <option {{ $asset_info->aa_location == $location_info->il_id ? "selected" : "" }} value="{{ $location_info->il_id }}">{{ $location_info->il_location_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select  name="aa_account_id" id="AA_ACCOUNT_ID" class="form-select" data-control="select2" data-placeholder="Select Account">
                                    ...
                                    @foreach ( $lst_accounts as $key => $account_info )
                                        <option {{ $asset_info->aa_account_id == $account_info->aa_id ? "selected" : "" }} value="{{ $account_info->aa_id }}">{{ $account_info->aa_account_label }} ({{ $account_info->aa_account_ref }})</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select  name="aa_status" id="AA_STATUS" class="form-select" data-control="select2" data-placeholder="Select Status">
                                    ...
                                    <option {{ $asset_info->aa_status == 1 ? "selected" : "" }} value="1">In-active</option>
                                    <option {{ $asset_info->aa_status == 2 ? "selected" : "" }} value="2">Active</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <label class="control-label">Description</label><br/>
                            <textarea style="width:100%;height:250px;" name="aa_asset_description" id="AA_ASSET_DESCRIPTION" class="form-control">{{  $asset_info->aa_asset_description }}</textarea>
                        </div>
                    </div>
