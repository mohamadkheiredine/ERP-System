...
@section('plugins')
    ...
    <script type="text/javascript" src="{{ url('js/libraries/assets/assets.js') }}"></script>
@endsection
    	 ...
    	 <span id="hidden_fields">
            ...
            <div class="row">
                ...
                <div class="col-md-2" style="text-align: right">
                    <a href="{{ url('assets/addform') }}" class="btn btn-info">
							<span>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-row-dashed table-row-gray-300 gy-7">
                            ...
                            <tbody  class="LstAssetsGrid"></tbody>
                        </table>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-10" align="left">
                    <ul id="AssetsPagination" class="pagination-sm"></ul>
                </div>
