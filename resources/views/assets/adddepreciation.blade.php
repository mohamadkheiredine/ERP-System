...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">Add Asset Depreciation</h3>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="ad_year" id="AD_YEAR" class="form-control" required="required" maxlength="12" value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="ad_depreciation_amount" id="AD_DEPRECIATION_AMOUNT" class="form-control" required="required" maxlength="12" value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">New Value <span class="required"> * </span></label>
                                <input type="text" name="ad_new_value" id="AD_NEW_VALUE" class="form-control" required="required" maxlength="12" value="" />
                            </div>
                        </div>
                    </div>
