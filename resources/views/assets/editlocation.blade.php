...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">Edit Asset Location</h3>
            ...
            <form name="frm_save_location" id="FORM_SAVE_LOCATION">
                <div class="form-body">
                    <span id="hidden_fields">
                        {!! csrf_field() !!}
                        <input type="hidden" name="il_id" value="{{  $asset_locations->il_id }}" />
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="il_location_name" id="IL_LOCATION_NAME" class="form-control" required="required" maxlength="255" value="{{  $asset_locations->il_location_name }}" />
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label class="control-label">Address <span class="required"> * </span></label>
                                <input type="text" name="il_address" id="IL_ADDRESS" class="form-control" required="required" maxlength="500" value="{{ $asset_locations->il_address }}" />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <label class="control-label">Description</label><br/>
                            <textarea style="width:100%;height:250px;" name="il_description" id="IL_DESCRIPTION" class="form-control">{{ $asset_locations->il_description }}</textarea>
                        </div>
                    </div>
