                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select  name="at_from_location_id" id="AT_FROM_LOCATION_ID" class="form-select" data-control="select2" data-placeholder="Select Location From">
                                    ...
                                    @foreach ($lst_asset_locations as $key => $loca_info )
                                        <option value="{{ $loca_info->il_id }}">{{ $loca_info->il_location_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="at_transfer_date" id="AT_TRANSFER_DATE" class="form-control" required="required" maxlength="10" readonly value="" />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <label class="control-label">Transfer Reason</label><br/>
                            <textarea style="width:100%;height:250px;" name="at_transfer_reason" id="AT_TRANSFER_REASON" class="form-control"></textarea>
                        </div>
                        <div class="col-md-12">
                            <label class="control-label">Remarks</label><br/>
                            <textarea style="width:100%;height:250px;" name="at_remarks" id="AT_REMARKS" class="form-control"></textarea>
                        </div>
                    </div>
