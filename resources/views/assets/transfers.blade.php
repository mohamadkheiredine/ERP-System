...
@section('plugins')
    ...
    <script type="text/javascript" src="{{ url('js/libraries/assets/transfer.js') }}"></script>
@endsection

@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">	Asset Transfers management</h3>
    	 ...
    	 <span id="hidden_fields">
            ...
            <div class="row">
                ...
                <div class="col-md-4" style="text-align: right">
                    <a href="{{ url('assets/transfers/addform') }}" class="btn btn-info">
							<span>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-row-dashed table-row-gray-300 gy-7">
                            ...
                            <tbody  class="LstAssetTransferGrid"></tbody>
                        </table>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-10" align="left">
                    <ul id="AssetTransferPagination" class="pagination-sm"></ul>
                </div>
