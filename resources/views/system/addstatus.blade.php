...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">Add New System Status</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="ss_status_title" id="SS_STATUS_TITLE" class="form-control" value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"> Status Color <span class="required"> * </span></label><br/>
                                <input type="color" name="ss_status_color" required="required" id="SS_STATUS_COLOR" class="form-control" value="" />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label"> Description</label><br/>
                                <textarea style="width:100%;height:250px;resize:none" id="SS_STATUS_DESCRIPTION"  class="form-control" name="ss_status_description"  cols=""></textarea>
                            </div>
                        </div>
                    </div>
