...
@extends('layouts.layout',['page_title' => "Job Roles Management > Add New Job Title"])
                    ...
                    <div class="row">
                        <div class="col-md-4">
                             <div class="form-group">
                                ...
                                <input type="text" name="jt_job_title" id="JT_JOB_TITLE" class="form-control" required="required" maxlength="100"  value="" />
                            </div>
                        </div>
                    </div>
