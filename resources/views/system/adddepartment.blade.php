	...
	<div class="m-portlet__head">
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				<h3 class="m-portlet__head-text">Add New Department</h3>
			</div>
		</div>
                    ...
                    <div class="row">
                    	<div class="col-md-4">
                             <div class="form-group">
                                ...
                                <input type="text" name="sd_department_code" id="SD_DEPARTMENT_CODE" class="form-control" required="required" maxlength="10"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                              <div class="form-group">
                                    <label class="control-label"> Department Order <span class="required"> * </span></label>
                                    <input type="number" name="sd_department_order" id="SD_DEPARTMENT_ORDER" class="form-control" required="required" step="1"  value="" />
                                </div>
                        </div>
                        <div class="col-md-4">
                             <div class="form-group">
                                <label class="control-label">Department Name <span class="required"> * </span></label>
                                <input type="text" name="sd_department_title" id="SD_DEPARTMENT_TITLE" class="form-control" required="required" maxlength="100"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                             <div class="form-group">
                        ...
                        <div class="col-md-4">
                                ...
                                <label class="control-label">Department Manager</label>
                                  <select name="sd_department_manager" id="SD_DEPARTMENT_MANAGER" class="form-control m-select2" style="width:100%">
                                        ...
                                        @foreach( $lst_managers as $key => $man_info)
                                         <option value="{{ $man_info->id }}">{{ $man_info->u_fullname }}</option>
                                        @endforeach 
                                    </select>
                            </div>
                        </div>
                         <div class="col-md-4">
                              <div class="form-group">
                                    <label class="control-label"> Department Color <span class="required"> * </span></label>
                                    <input type="color" name="sd_department_color" id="SD_DEPARTMENT_COLOR" class="form-control" value="" />
                                </div>
                        </div>
                    </div>
