...
@extends('layouts.layout',['page_title' => "Job Roles Management > Add New Job Role"])
...
<div class="card shadow-sm">
    <div class="card-header">
        <h3 class="card-title">Add New Job Role</h3>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                             <div class="form-group">
                                ...
                                <input type="text" name="jr_job_role" id="JR_JOB_ROLE" class="form-control" required="required" maxlength="100"  value="" />
                            </div>
                        </div>
                    </div>
