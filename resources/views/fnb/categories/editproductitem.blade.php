...
<script type="text/javascript" src="{{ url('js/libraries/fnb/category/saveItem.js') }}"></script>
@endsection
    ...
    <form name="frm_save_items" id="FORM_SAVE_ITEM">
      <div class="form-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="fi_item_name" id="FI_ITEM_NAME" class="form-control"
                 required maxlength="255" value="{{ $item_info->fi_item_name }}" />
        </div>
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="text" name="p_bar_code" id="P_BAR_CODE" class="form-control" maxlength="50"
                   value="{{ $item_info->fi_barcode }}" readonly />
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <label class="form-check form-switch form-check-custom form-check-solid">
            <input class="form-check-input" type="checkbox" name="fi_is_active" id="FI_IS_ACTIVE" value="1"
              {{ $item_info->fi_is_active ? 'checked' : '' }} />
        ...
        <div class="form-group">
          <label class="form-check form-switch form-check-custom form-check-solid">
            <input class="form-check-input" type="checkbox" name="fi_is_sellable" id="FI_IS_SELLABLE" value="1"
              {{ $item_info->fi_is_sellable ? 'checked' : '' }} />
        ...
        <div class="form-group">
          <label class="form-check form-switch form-check-custom form-check-solid">
            <input class="form-check-input" type="checkbox" name="fi_is_stock_item" id="FI_IS_STOCK_ITEM" value="1"
              {{ $item_info->fi_is_stock_item ? 'checked' : '' }} />
        ...
        <div class="form-group">
          <label class="form-check form-switch form-check-custom form-check-solid">
            <input class="form-check-input" type="checkbox" name="fi_print_to_kitchen" id="FI_PRINT_TO_KITCHEN" value="1"
              {{ $item_info->fi_print_to_kitchen ? 'checked' : '' }} />
