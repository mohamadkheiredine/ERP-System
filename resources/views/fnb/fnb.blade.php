...
@extends('layouts.layout',['page_title' => "Floor Management"])
...
@section('plugins')
    ...
    <script type="text/javascript" src="{{ url('js/libraries/floors/floors.js') }}"></script>
@endsection

@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">FNB</h3>
        ...
        <span id="hidden_fields">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-8 order-2 order-xl-1">
                        <div class="form-group m-form__group row align-items-center">
                            ...
                            <div class="col-md-4">
                                <select class="form-select form-control" data-control="select2" id="FL_BRAMCH_ID" name="fl_branch_id" name="lead_category">
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 align-right" style="text-align: right">
                        <a href="{{ url('fnb/floors/addform') }}" class="btn btn-info">
                        <span>
            ...
            <div class="col-md-12">
                ...
                <table class="table table-bordered table-hover" width="100%">
                    ...
                    <tbody class="LstFloorsGrid" id="LstFloorsGrid">
                    </tbody>
                </table>
            </div>
            <div class="row">
                <div class="col-md-10" align="left">
                    <ul id="FloorsPagination" class="pagination-sm"></ul>
                </div>
