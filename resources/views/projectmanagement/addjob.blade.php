                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="pj_job_code" id="PJ_JOB_CODE" class="form-control" readonly required="required" maxlength="25"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"> Job Title <span class="required"> * </span></label>
                                <input type="text" name="pj_job_name" id="PJ_JOB_NAME" class="form-control" required="required" maxlength="255"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"> Planned Start Date</label>
                                <input type="text" name="pj_planned_start" id="PJ_PLANNED_START" class="form-control" readonly required="required" maxlength="25"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"> Planned End Date</label>
                                <input type="text" name="pj_planned_end" id="PJ_PLANNED_END" class="form-control" required="required" maxlength="25"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"> Actual Start Date</label>
                                <input type="text" name="pj_actual_start" id="PJ_ACTUAL_START" class="form-control" readonly required="required" maxlength="25"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"> Actual End Date</label>
                                <input type="text" name="pj_actual_end" id="PJ_ACTUAL_END" class="form-control" required="required" maxlength="25"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea style="width:100%;height:250px;resize:none" id="PJ_DESCRIPTION"  class="form-control" name="pj_description"  cols=""></textarea>
                            </div>
                        </div>
                    </div>
