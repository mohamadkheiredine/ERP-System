...
<div class="card shadow-sm">
    <div class="card-header">
        <h3 class="card-title">Edit Existing Case Management</h3>
                    ...
                    <div class="row">
                         ...
                         <div class="col-md-4">
                             <div class="form-group">
                                ...
                                <input type="text" name="cc_case_label" id="CC_CASE_LABEL" maxlength="255" class="form-control" value="{{ $case_info->cc_case_label }}" />
                             </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                  <label class="control-label"> Agent <span class="required"> * </span> </label>
                                   <select name="cc_assigned_agent_id" id="CC_ASSIGNED_AGENT_ID"   class="form-control form-select" data-control="select2" data-placeholder="Select Assigned Agent">
                                          ...
                                          @foreach($lst_agents as $key => $agent_info)
                                                  <option {{ $case_info->cc_assigned_agent_id == $agent_info->id ? "selected" : "" }} value="{{ $agent_info->id }}">{{ $agent_info->u_fullname }}</option>
                                          @endforeach
                                  </select>
                              </div>
                        </div> 
                        ...
                        <div class="col-md-4">
                                  ...
                                  <label class="control-label"> Case Inbound Call <span class="required"> * </span> </label>
                                   <select name="cc_call_id" id="CC_CALL_ID"   class="form-control form-select" data-control="select2" data-placeholder="Select Case Call">
                                          ...
                                          @foreach($lst_inbound_calls as $key => $call_info)
                                                  <option {{ $case_info->cc_call_id == $call_info->ic_id ? "selected" : "" }} value="{{ $call_info->ic_id }}">{{ $call_info->cc_case_label }}</option>
                                          @endforeach
                                  </select>
                              </div>
                        </div> 
                         <div class="col-md-4">
                             <div class="form-group">
                                ...
                                <input type="text" name="cc_case_deadline" required="required" id="CC_CASE_DEADLINE" class="form-control" value="{{ $case_info->cc_case_deadline }}" />
                             </div>
                        </div>
                         <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"> Case Resolution Date <span class="required"> * </span></label><br/>
                                <input type="text" name="cc_resolution_date" required="required" id="CC_RESOLUTION_DATE" class="form-control" value="{{ $case_info->cc_resolution_date }}" />
                             </div>
                        </div>  
                        <div class="col-md-12">
                             <div class="form-group">
