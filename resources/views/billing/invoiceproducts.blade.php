...
<table border="0" class="tablesection" style="background-color:white;width:100%;">
    ...
    @for ($i = count($items_array); $i < 10; $i++)
        <tr>
            <td style="height:45px;text-align: left !important;border-top:solid 1px black" align="center">&nbsp;</td>
            <td style="height:45px;border-top:solid 1px black" align="center">&nbsp;</td>
            <td style="height:45px;border-top:solid 1px black" align="center">&nbsp;</td>
            <td style="height:45px;border-top:solid 1px black" align="center">&nbsp;</td>
        </tr>
    @endfor
