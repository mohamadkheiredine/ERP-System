...
@extends('layouts.layout',['page_title' => "Invoice Templates Management"])
...
<script type="text/javascript" src="{{ url('js/libraries/billing/invoicetemplates.js') }}"></script>
@endsection

@section('content')
<div class="card shadow-sm">
    <div class="card-header">
        <h3 class="card-title">Invoice Templates Management</h3>
    ...
    <div class="card-body">
            ...
            <div class="row align-items-center">
                <div class="col-xl-12 order-2 order-xl-1">
                    <div class="row">
                        ...
                        <div class="col-md-4"> 
                                <select class="form-select form-select-solid" id="INVOICE_CUSTOMER" name="invoice_customer" data-control="select2" data-placeholder="Select a Customer">
                        ...
                        <div class="col-md-4">
                            <a href="{{ url('billing/invoicetemplates/addform') }}" class="btn btn-info">
                                <span>
                    ...
                    <table class="table table-rounded table-striped border gy-7 gs-7">
                        <thead>
                            <tr class="fw-semibold fs-6 text-gray-800 border-bottom border-gray-200">
                                ...
                                <th  style="width:5%" title="Code"> Code </th>
                                <th  style="width:5%" title="Label"> Label </th>
        ...
        <div class="row">
            <div class="col-md-10" align="left">
                <ul id="InvoiceTemplatesPagination" class="pagination-sm"></ul>
            </div>
