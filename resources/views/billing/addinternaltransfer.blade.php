	...
	<div class="m-portlet__head">
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				<h3 class="m-portlet__head-text">Add New Internal Transfer</h3>
			</div>
		</div>
             ...
             <form name="frm_save_internaltransfers" id="FORM_SAVE_INTERNALTRANSFERS">
                <div class="form-body">
                     <span id="hidden_fields">
                        ...
                        <input type="hidden" name="transfer_code" value="{{ $internal_code }}" /> 
                    </span>
                    ...
                    <div class="row">
                         <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="text" name="in_transfer_code" id="IN_TRANSFER_CODE" class="form-control"  maxlength="255" readonly="readonly"  value="{{ $internal_code }}" />
                                </div>
                        </div>   
                         <div class="col-md-4">
                              <div class="form-group">
                                    <label class="control-label">Transfer Label</label>
                                    <input type="text" name="in_transfert_label" id="IN_TRANSFER_LABEL" class="form-control"  maxlength="255"  value="" />
                                </div>
                        </div>   
                        <div class="col-md-4">
                              <div class="form-group">
                                    <label class="control-label"> Transfer Date </label>
                                    <input type="text" name="in_transfer_date" id="IN_TRANSFER_DATE" class="form-control"  maxlength="15"  value="" />
                                </div>
                        </div>
                         <div class="col-md-4">
                             <div class="form-group">
                        ...
                        <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="text"  name="in_credit_value" id="IN_CREDIT_VALUE" class="form-control"  maxlength="50"  value="0" />
                                </div>
                        </div>
                        <div class="col-md-4">
                              <div class="form-group">
                                    <label class="control-label"> Debit Ammount </label>
                                    <input type="text"  name="in_debit_value" id="IN_DEBIT_VALUE" class="form-control"  maxlength="50"  value="0" />
                                </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="text"  name="in_exchange_rate" id="IN_EXCHANGE_RATE" class="form-control" value="0" />
                                </div>
                        </div> 
                        <div class="col-md-12">
                             <div class="form-group">
                                <label class="control-label">Transfer Notes</label>
                                <textarea style="width:100%;height: 250px;" class="form-control" name="in_transfer_notes" id="IN_TRANSFER_NOTES" ></textarea>
                            </div>
                        </div>
                    </div>
