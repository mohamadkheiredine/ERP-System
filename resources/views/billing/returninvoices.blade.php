...
@section('plugins')
    ...
    <script type="text/javascript" src="{{ url('js/libraries/billing/returninvoicesmanagement.js') }}"></script>
@endsection

@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">Return Invoices Management</h3>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12 order-1 order-xl-2 align-right">
                    <a href="{{ url('billing/returninvoices/return') }}" class="btn btn-info">
						<span>
                    ...
                    <div class="table-responsive">
                        <table class="table table-rounded table-striped border gy-7 gs-7">
                            ...
                            <tr class="fw-semibold fs-6 text-gray-800 border-bottom border-gray-200">
                                ...
                                <th  title="Invoice Ref"> Invoice Ref </th>
                                <th   title="Return Invoice Ref"> Return Invoice Ref </th>
                                <th  title="Date"> Date </th>
                                <th  title="Return Date">Return Date </th>
                                <th  style="width:12%" title="Total Price"> Total Price </th>
                                <th style="width:2px;" nowrap title="edit"> view </th>
                            </tr>
                            </thead>
