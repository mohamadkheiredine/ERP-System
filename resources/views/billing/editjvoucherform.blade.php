...
<div class="card shadow-sm">
    <div class="card-header">
        <h3 class="card-title">Edit Journal Voucher</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="text" name="pj_creation_date" id="PJ_CREATION_DATE" class="form-control"  maxlength="50" readonly="readonly"  value="{{ date('d/m/Y',strtotime($jv_info->pj_creation_date)) }}" />
                                </div>
                        </div>
                         <div class="col-md-4">
                             <div class="form-group">
