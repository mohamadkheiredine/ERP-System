	...
	<div class="m-portlet__head">
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				<h3 class="m-portlet__head-text">Add New Credit Note</h3>
			</div>
		</div>
             ...
             <form name="frm_save_creditnotes" id="FORM_SAVE_CREDITNOTES">
                <div class="form-body">
                     <span id="hidden_fields">
                        ...
                        <input type="hidden" name="cn_credit_code" value="{{ $credit_code }}" /> 
                    </span>
                    ...
                    <div class="row">
                         <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="text" name="cn_code" id="CN_CODE" class="form-control"  maxlength="255" readonly="readonly"  value="{{ $credit_code }}" />
                                </div>
                        </div>   
                         <div class="col-md-4">
                              <div class="form-group">
                                    <label class="control-label">Credit Label</label>
                                    <input type="text" name="cn_credit_label" id="CN_CREDIT_LABEL" class="form-control"  maxlength="255"  value="" />
                                </div>
                        </div>   
                        <div class="col-md-4">
                              <div class="form-group">
                                    <label class="control-label"> Credit Date </label>
                                    <input type="text" name="cn_credit_date" id="CN_CREATION_DATE" class="form-control"  maxlength="255"  value="" />
                                </div>
                        </div>
                         <div class="col-md-4">
                             <div class="form-group">
                        ...
                        <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="text"  name="cn_credit_value" id="CN_CREDIT_VALUE" class="form-control"  maxlength="50"  value="1" />
                                </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="text"  name="cn_exchange_rate" id="CN_EXCHANGE_RATE" class="form-control" value="0" />
                                </div>
                        </div> 
                        <div class="col-md-12">
                             <div class="form-group">
                                <label class="control-label">Credit Notes</label>
                                <textarea style="width:100%;height: 250px;" class="form-control" name="cn_credit_notes" id="CN_CREDIT_NOTES" ></textarea>
                            </div>
                        </div>
                    </div>
