	...
	<div class="m-portlet__head">
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				<h3 class="m-portlet__head-text">Add New Payment Voucher</h3>
			</div>
		</div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="text" name="pv_code" id="PV_CODE" class="form-control"  maxlength="15"  value="{{ $voucher_code }}" readonly="readonly" />
                                </div>
                        </div>
                         <div class="col-md-4">
                              <div class="form-group">
                        ...
                        <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="text"  name="pv_exchange_rate" id="PV_EXCHANGE_RATE" class="form-control" value="0" />
                                </div>
                        </div>
                        <div class="col-md-10">
