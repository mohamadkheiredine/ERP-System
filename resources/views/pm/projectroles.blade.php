...
@section('plugins')
    ...
    <script type="text/javascript" src="{{ url('js/libraries/pmp/projectroles.js') }}"></script>
@endsection
...
@section('content')
    ...
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">Project Roles Management</h3>
        ...
        <div class="card-body">
            ...
            <div class="col-md-12">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 align-right">
                        <a href="{{ url('projects/roles/addform') }}" class="btn btn-info">
						<span>
            ...
            <div class="row">
                <div class="col-md-10" align="left">
                    <ul id="ProjectRolesPagination" class="pagination-sm"></ul>
                </div>
