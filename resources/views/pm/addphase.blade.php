                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="pp_phase_code" id="PP_PHASE_CODE" class="form-control" readonly required="required" maxlength="25"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"> Phase Title <span class="required"> * </span></label>
                                <input type="text" name="pp_phase_name" id="PP_PHASE_NAME" class="form-control" required="required" maxlength="255"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"> Planned Start Date</label>
                                <input type="text" name="pp_planned_start" id="PP_PLANNED_START" class="form-control" readonly required="required" maxlength="25"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"> Planned End Date</label>
                                <input type="text" name="pp_planned_end" id="PP_PLANNED_END" class="form-control" required="required" maxlength="25"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"> Actual Start Date</label>
                                <input type="text" name="pp_actual_start" id="PP_ACTUAL_START" class="form-control" readonly required="required" maxlength="25"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"> Actual End Date</label>
                                <input type="text" name="pp_actual_end" id="PP_ACTUAL_END" class="form-control" required="required" maxlength="25"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea style="width:100%;height:250px;resize:none" id="PP_PHASE_DESCRIPTION"  class="form-control" name="pp_phase_description"  cols=""></textarea>
                            </div>
                        </div>
                    </div>
