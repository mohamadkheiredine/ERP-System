...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">Project Roles Management > Add New Project Role</h3>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="pr_name" id="PR_NAME" class="form-control" required="required" maxlength="255"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <label class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" name="pr_is_billable_default" id="PR_IS_BILLABLE_DEFAULT"  value="1"  />
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea style="width:100%;height:250px;resize:none" id="PR_DESCRIPTION"  class="form-control" name="pr_description"  cols=""></textarea>
                            </div>
                        </div>
                    </div>
