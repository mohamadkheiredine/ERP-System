...
@extends('layouts.layout',['page_title' => "Project Status"])
...
<script type="text/javascript" src="{{ url('js/libraries/pmp/projectstatus.js') }}"></script>
@endsection
		...
		<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
			...
			<div class="row align-items-center">
				...
				<div class="col-xl-4 order-1 order-xl-2 m--align-right">
					<a href="{{ url('projects/statuses/addform') }}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
						<span>
		...
		<div class="row">
			<div class="col-md-12" align="center">
				<table class="table table-bordered" style="width:80%">
            		...
            		<tbody  id="LstProjectStatses"></tbody>
            </table>
			</div>
		</div>
		 <div class="row">
             <div class="col-md-10" align="left">
                <ul id="ProjectStatusesPagination" class="pagination-sm"></ul>
             </div>
             <div class="col-md-2" align="right"></div>
         </div>
		<div class="row">
			<div class="col-md-12 order-1 order-md-1 m--align-right">
				<a href="{{ url('projects/statuses/addform') }}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
					<span>
						<i class="fas fa-user"></i>
						<span>
