	...
	<div class="m-portlet__head">
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				<h3 class="m-portlet__head-text">Add New Receipt</h3>
			</div>
		</div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="text" name="br_receipt_number" id="BR_RECEIPT_NUMBER" class="form-control"  maxlength="15"  value="{{ $receipt_code }}" readonly="readonly" />
                                </div>
                        </div>
                        <div class="col-md-4" >
                             <div class="form-group">
                        ...
                        <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="number" min="0" max="9999999" step="1.0" name="br_exchange_rate" id="BR_EXCHANGE_RATE" class="form-control"  maxlength="15"  value="0" />
                                </div>
                        </div>
                         <div class="col-md-4">
                            <div class="form-group">
                           ...
                           <div class="m-form__group form-group row">
								<div class="col-12">
									<span class="m-switch m-switch--icon m-switch--info">
										<label>
											<input type="checkbox"  name="br_receipt_paid" checked="checked" value="1" />
											<span></span>
										</label>
									</span>
								</div>
