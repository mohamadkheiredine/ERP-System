    ...
    <form name="frm_save_product" id="FORM_SAVE_PRODUCT">
                <div class="form-body">
                     <span id="hidden_fields">
                      {!! csrf_field() !!}
                      <input type="hidden" name="p_barecode" value="{{ $product_info->p_barcode }}" />
                      <input type="hidden" name="p_barecode_img" value="{{ $product_info->p_barecode_img }}" />
                      <input type="hidden" name="p_id" id="P_ID" value="{{ $product_info->p_id }}" />
                    </span>
                   ...
                   <div class="row">
    							 <div class="col-md-4">
                                    <div class="form-group">
                                         ...
                                         <label class='lblbarcode'>{{ $product_info->p_barcode }}</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                      <div class="form-group">
                                ...
                                <div class="col-md-4">
                                      <div class="form-group">
                                            ...
                                            <input type="text" maxlength="255" name="p_product_name" id="P_PRODUCT_NAME" maxlength="255" class="form-control" required="required"   value="{{ $product_info->p_product_name }}" />
                                        </div>
                                </div>
                                <div class="col-md-4">
                                      <div class="form-group">
                                            <label class="control-label"> Product Stock Alert <span class="required"> * </span></label>
                                            <input type="text" maxlength="255" name="p_product_stock_alert" id="P_STOCK_ALERT" class="form-control" required="required" maxlength="15"  value="{{ $product_info->p_product_stock_alert }}" />
                                        </div>
                                </div>
                                <div class="col-md-4">
                                      <div class="form-group">
                                ...
                                <div class="row">
                            		<div class="col-md-4">
                                          <div class="form-group">
                                                ...
                                                <input type="text" maxlength="15" name="p_product_selling_price" id="P_PRODUCT_SELLING_PRICE" class="form-control" required="required"   value="{{ $product_info->p_product_selling_price }}" />
                                            </div>
                                    </div>
                                    <div class="col-md-4">
                                          <div class="form-group">
                                                <label class="control-label"> Product Min Selling Price&nbsp;<b class="CurrencyCode">{{  $product_info->p_product_currency == null  ? session('currency_symbol') : $currency_array[ $product_info->p_product_currency ]['cc_currency_code'] }}</b> <span class="required"> * </span></label>
