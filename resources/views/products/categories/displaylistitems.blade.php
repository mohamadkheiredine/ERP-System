...
<tr class="odd gradeX" data-p_id="{{ $product_info->p_id }}">
   ...
   <td><span class="SellingPrice">{{ $product_info->p_product_selling_price }}</span>&nbsp;&nbsp;<b>{{ $product_info->Currency ? $product_info->Currency->cc_currency_code : "" }}</b></td>
   <td>{{ $product_info->p_product_discount }}&nbsp;&nbsp;<b>%</b></td>
   <td>{{ $product_info->p_wholesale_price }}&nbsp;&nbsp;<b>{{ $product_info->Currency ? $product_info->Currency->cc_currency_code : "" }}</b></td>
   <td>{{ $product_info->p_vendor_price }}&nbsp;&nbsp;<b>{{ $product_info->Currency ? $product_info->Currency->cc_currency_code : "" }}</b></td>
