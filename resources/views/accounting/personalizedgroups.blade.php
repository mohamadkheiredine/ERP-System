...
@extends('layouts.layout',['page_title' => "Personalized Groups"])
...
<script type="text/javascript" src="{{ url('js/libraries/accounting/personalizedgroups.js') }}"></script>
@endsection

@section('content')
<div class="card shadow-sm">
    <div class="card-header">
        <h3 class="card-title">Personalized Groups</h3>
	...
	<table class="table table-rounded table-striped border gy-7 gs-7" style="width:100%">
        <thead>
        	<tr>
        		<th title="Id">ID</th>
        ...
        <tbody id="LstPersonalizedGroups">
	...
	<div class="col-xl-12 order-1 order-xl-12 align-right" style="margin-top: 12px;">
		<a href="{{ url('accounting/personalizedgroups/addform') }}" class="btn btn-info">
			<span>
