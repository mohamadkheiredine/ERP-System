...
<div class="m-portlet m-portlet--mobile">
    ...
    <div class="m-portlet__body">
    	...
    	<!--end: Search Form -->
          <!--begin: Datatable -->
    	<div id="LstVatAccounts" class="m_datatable">
    	...
    	<div class="col-xl-12 order-1 order-xl-12 m--align-right" style="margin-top: 12px;">
    		...
    		<div class="col-xl-12 order-1 order-xl-12 m--align-right">
				<a href="{{ url('accounting/vataccounts/addform') }}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
					<span>
