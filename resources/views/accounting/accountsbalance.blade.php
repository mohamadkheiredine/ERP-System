...
?>
@extends('layouts.layout',['page_title' => "Account Balance"])
...
<script type="text/javascript" src="{{ url('js/libraries/accounting/accountbalance.js') }}"></script>
@endsection
...
<div class="m-portlet m-portlet--mobile">
	...
	<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row align-items-center">
						...
						<div class="col-md-4">
							<div class="form-group">
                                ...
                                <select class="bs-select form-control" name="acc_account_payable" id="ACC_ACCOUNT_PAYABLE" data-actions-box="true">
						...
						<div class="col-md-4">
							<div class="form-group">
                                ...
                                <select class="bs-select form-control" name="acc_account_receivable" id="ACC_ACCOUNT_RECEIVABLE" data-actions-box="true">
                                        <option value="0"> --Select Account--</option>
                                        @foreach ( $lst_accounts as $key => $account_info )
                                                <option value="{{ $account_info->aa_id }}">{{ $account_info->aa_account_ref . " - " . $account_info->aa_account_label }}</option>
                                        @endforeach
		...
		<!--end: Search Form -->
          <!--begin: Datatable -->
		<div class="m_datatable" id="LstAccountBalance">
