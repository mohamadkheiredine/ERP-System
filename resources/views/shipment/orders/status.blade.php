...
<script type="text/javascript" src="{{ url('js/libraries/shipment/orders/status.js') }}"></script>
@endsection
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-10" align="left">
                <ul id="StatusesPagination" class="pagination-sm"></ul>
            </div>
