							...
							@if(isset($license_array->SRM_MODULE) && $license_array->SRM_MODULE == 1)
								<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-end" class="menu-item py-2">
									...
									<div class="menu-sub menu-sub-dropdown menu-sub-indention px-2 py-4 w-250px mh-75 overflow-auto">
										...
										<div class="menu-item">
											<!--begin:Menu link-->
											<a class="menu-link" href="{{ url('srm/supplier/bidding') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Supplier Bidding</span>
											</a>
											<!--end:Menu link-->
										</div> 
										<div class="menu-item">
											...
											<a class="menu-link" href="{{ url('srm/bidding/quotations') }}">
												...
												<span class="menu-title">Supplier Quotations</span>
											</a>
											<!--end:Menu link-->
										</div> 
										<div class="menu-item">
											<!--begin:Menu link-->
											<a class="menu-link" href="{{ url('srm/suppliercontracts') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Supplier Contracts</span>
											</a>
											<!--end:Menu link-->
										</div> 
									</div>
