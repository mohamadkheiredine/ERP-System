...
@extends('layouts.layout',['page_title' => "Add New Category"])
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="text" name="cca_category_name" id="CCA_CATEGORY_NAME" class="form-control" required="required" maxlength="255" value="" />
						</div>
					</div>
					<div class="col-md-4">
                             <div class="form-group">
                                <label class="control-label">Parent Category</label>
                                 <select class="bs-select form-control" name="fk_cca_id" id="FK_CCA_ID" data-actions-box="true">
                                        ...
                                        @foreach ( $lst_costcenter_categories as $key => $category_info )
					...
					<div class="col-md-12">
						...
						<textarea style="width:100%;height:250px;" name="cca_description" id="CCA_DESCRIPTION" class="form-control"></textarea>
					</div>
				</div>
