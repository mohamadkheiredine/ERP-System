...
@section('plugins')
    ...
    <script type="text/javascript" src="{{ url('js/libraries/payrolls/saveperiod.js') }}"></script>
@endsection
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="pp_period_name" id="PP_PERIOD_NAME" class="form-control" maxlength="255"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="pp_start_date" id="PP_START_DATE" class="form-control" required="required" maxlength="20"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">End Date <span class="required"> * </span></label>
                                <input type="text" name="pp_end_date" id="PP_END_DATE" class="form-control" required="required" maxlength="20"  value="" />
                            </div>
                        </div>
                    </div>
