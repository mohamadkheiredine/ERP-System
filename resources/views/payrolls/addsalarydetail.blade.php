...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">Add New Salary Details</h3>
                ...
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" >
                            <div class="form-group">
                                ...
                                <input type="text" name="pd_basic_salary" id="PD_BASIC_SALARY" class="form-control" maxlength="25"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4" >
                            <div class="form-group">
                                <label class="control-label"> Allowances <span class="required"> * </span></label>
                                <input type="text" name="pd_allowances" id="PD_ALLOWANCES" class="form-control" maxlength="25"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Deduction <span class="required"> * </span></label>
                                <input type="text" name="pd_deductions" id="PD_DEDUCTION" class="form-control" required="required" maxlength="25"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Total Comissions <span class="required"> * </span></label>
                                <input type="text" name="pd_total_comissions" id="PD_TOTAL_COMISSION" class="form-control" required="required" maxlength="25"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="pd_effective_date" id="PD_EFFECTIVE_DATE" class="form-control" required="required" maxlength="20"  value="{{ $first_day_month }}" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">End Date <span class="required"> * </span></label>
                                <input type="text" name="pd_end_date" id="PD_END_DATE" class="form-control" required="required" maxlength="20"  value="{{ $last_day_month }}" />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label"> Description</label><br/>
                                <textarea style="width:100%;height:250px;resize:none" id="PD_DESCRIPTION"  class="form-control" name="pd_description"  cols=""></textarea>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5" align="right">
                            ...
                            <button type="button" id="BTN_GENERATE_TRANSACTION" name="btn_generate_transaction" class="btn btn-danger">Generate Transaction</button>
                            <button type="button" id="BACK_FORM" name="back_form" class="btn btn-default">Back</button>
                        </div>
                    </div>
                </div>
            </form>
