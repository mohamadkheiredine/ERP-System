...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">Add New Tax Bracket</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" >
                            <div class="form-group">
                                ...
                                <input type="text" name="tb_bracket_code" id="TB_BRACKET_CODE" class="form-control" maxlength="10"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4" >
                            <div class="form-group">
                                <label class="control-label"> Bracket Label <span class="required"> * </span></label>
                                <input type="text" name="tb_bracket_label" id="TB_BRACKET_LABEL" class="form-control" maxlength="255"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Min Salary <span class="required"> * </span></label>
                                <input type="text" name="tb_min_salary" id="TB_MIN_SALARY" class="form-control" required="required" maxlength="20"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Max Salary <span class="required"> * </span></label>
                                <input type="text" name="tb_max_salary" id="TB_MAX_SALARY" class="form-control" required="required" maxlength="20"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Tax Rate <span class="required"> * </span></label>
                                <input type="text" name="tb_tax_rate" id="TB_TAX_RATE" class="form-control" required="required" maxlength="20"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Region <span class="required"> * </span></label>
                                <input type="text" name="tb_region" id="TB_REGION" class="form-control" required="required" maxlength="255"  value="" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea style="width:100%;height:250px;resize:none" id="TB_BRACKET_DESCRIPTION"  class="form-control" name="tb_bracket_description"  cols=""></textarea>
                            </div>
                        </div>
