    ...
    <form name="frm_save_vendor" id="FORM_SAVE_VENDOR">
                <div class="form-body">
                     <span id="hidden_fields">
                      	{!! csrf_field() !!}
                      	<input type="hidden" name="iv_id" value="{{ $vendor_info->iv_id }}" />
                    </span>
                             ...
                             <div class="col-md-4">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                        <img id="VENDOR_LOGO_PIC" width="100" src="{{ $img_src }}" alt="" /> </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <input type="text" readonly="readonly" name="iv_vendor_code" id="IV_VENDOR_CODE" class="form-control" required="required" maxlength="15"  value="{{ $vendor_info->iv_vendor_code }}" />
                                </div>
                        </div>
                        <div class="col-md-4">
                             <div class="form-group">
                                <label class="control-label">Vendor Name <span class="required"> * </span></label>
                                <input type="text" name="iv_vendor_name" id="IV_VENDOR_NAME" class="form-control" required="required" maxlength="255"  value="{{ $vendor_info->iv_vendor_name }}" />
                            </div>
                        </div>
                        <div class="col-md-4">
                             <div class="form-group">
                                <label class="control-label">Vendor Warehouse  <span class="required"> * </span></label>
                                 <select class="bs-select form-control" name="iv_warehouse_id" id="IV_WAREHOUSE_ID" data-actions-box="true">
                                        @foreach ( $lst_warehouses as $key => $warehouse_info )
                                                <option {{ $vendor_info->iv_warehouse_id == $warehouse_info->w_id ? "selected" : ""  }} value="{{ $warehouse_info->w_id }}">{{ $warehouse_info->w_warehouse_name }}</option>
                                        @endforeach
                                </select>
                            </div>
                        </div>
                                ...
                                <label class="control-label">Vendor Country </label>
                                 <select class="bs-select form-control" name="iv_vendor_country" id="IV_VENDOR_COUNTRY" data-actions-box="true">
                                        @foreach ( $lst_countries as $key => $count_info )
                                                <option  {{ $vendor_info->iv_vendor_country == $warehouse_info->id ? "selected" : ""  }} value="{{ $count_info->id }}">{{ $count_info->name }}</option>
                                        @endforeach
                                </select>
                            </div>
                        </div>
                                ...
                                <label class="control-label">Vendor Tax </label>
                                 <select class="bs-select form-control" name="iv_vendor_tax_id" id="IV_VENDOR_TAX_ID" data-actions-box="true">
                                        @foreach ( $lst_vat_tax as $key => $vat_info )
                                                <option {{ $vendor_info->iv_vendor_tax_id == $vat_info->av_id ? "selected" : ""  }} value="{{ $vat_info->av_id }}">{{ $vat_info->av_vat_label . "(" . $vat_info->av_vat_code . ")" }}</option>
                                        @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                             <div class="form-group">
                                ...
                                <input type="email" name="iv_vendor_email" id="IV_VENDOR_EMAIL" class="form-control" required="required" maxlength="255"  value="{{ $vendor_info->iv_vendor_email }}" />
                            </div>
                        </div>
                        <div class="col-md-4">
                             <div class="form-group">
                                <label class="control-label">Vendor Website </label>
                                <input type="url" name="iv_vendor_website" id="IV_VENDOR_WEBSITE" class="form-control" required="required" maxlength="255"  value="{{ $vendor_info->iv_vendor_website }}" />
                            </div>
                        </div>
                        <div class="col-md-4">
                             <div class="form-group">
                                <label class="control-label">Vendor Phone </label>
                                <input type="tel" name="iv_vendor_phone" id="IV_VENDOR_PHONE" class="form-control" maxlength="255"  value="{{ $vendor_info->iv_vendor_phone }}" />
                            </div>
                        </div>
                        <div class="col-md-4">
                             <div class="form-group">
                                <label class="control-label">Vendor mobile </label>
                                <input type="tel" name="iv_vendor_mobile" id="IV_VENDOR_MOBILE" class="form-control"   maxlength="255"  value="{{ $vendor_info->iv_vendor_mobile }}" />
                            </div>
                        </div>
                        <div class="col-md-8">
                             <div class="form-group">
                        ...
                        <div class="col-md-12">
                             <div class="form-group">
                                ...
                                <textarea style="width:100%;height:250px;resize:none" id="IV_VENDOR_DESCRIPTION"  class="form-control" name="iv_vendor_description"  cols="">{{ $vendor_info->iv_vendor_description }}</textarea>
                             </div>
                        </div>
                    </div>
                   <div class="row" style="height:5px;"></div>
                        <div class="row">
                            ...
                            <div class="col-md-3" align="right">
                                 <button type="submit" name="btn_save_vendor" id="BTN_SAVE_VENDOR"  class="btn btn-info">Save</button>
