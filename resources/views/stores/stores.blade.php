...
@extends('layouts.layout',['page_title' => "Store Management"])
...
@section('plugins')
    ...
    <script type="text/javascript" src="{{ url('js/libraries/stores/stores.js') }}"></script>
@endsection
        ...
        <span id="hidden_fields">
            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 align-right" style="text-align: right">
                        <a href="{{ url('stores/addform') }}" class="btn btn-info">
                        <span>
            ...
            <div class="col-md-12">
                ...
                <table class="table table-bordered table-hover" width="100%">
                    ...
                    <tbody class="LstStoresGrid" id="LstStoresGrid">
                    </tbody>
                </table>
            </div>
            <div class="row">
                <div class="col-md-10" align="left">
                    <ul id="StoresPagination" class="pagination-sm"></ul>
                </div>
