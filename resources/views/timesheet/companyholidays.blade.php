...
<script type="text/javascript" src="{{ url('js/libraries/timesheet/companyholidays.js') }}"></script>
@endsection
									...
									<div class="row align-items-center">
										<div class="col-xl-8 order-2 order-xl-1">
											<div class="form-group m-form__group row align-items-center">
												...
												<div class="col-md-4">
                                                    <select name="holiday_year" id="HOLIDAY_YEAR" class="form-control">
										...
										<div class="col-xl-4 order-1 order-xl-2 m--align-right">
											<a href="{{ url('timesheet/holidays/addform') }}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
												<span>
