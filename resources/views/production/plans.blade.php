			...
			<div class="row align-items-center">
				<div class="col-xl-8 order-2 order-xl-1">
					<div class="form-group m-form__group row align-items-center">
						...
						<div class="col-md-4">
							 <select class="bs-select form-control" name="ps_plan_status" id="PS_PLAN_STATUS" data-actions-box="true">
				...
				<div class="col-xl-4 order-1 order-xl-2 m--align-right">
					<a href="{{ url('production/plan/addform') }}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
						<span>
